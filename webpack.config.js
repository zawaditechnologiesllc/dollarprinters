    ...
    plugins: [
        ...
        new webpack.DefinePlugin({
            'process.env': JSON.stringify({
                ...
                TRANSLATIONS_CDN_URL: process.env.TRANSLATIONS_CDN_URL || '',
                R2_PROJECT_NAME: process.env.R2_PROJECT_NAME || '',
                CROWDIN_BRANCH_NAME: process.env.CROWDIN_BRANCH_NAME || '',
                TRACKJS_TOKEN: process.env.TRACKJS_TOKEN || '',
                APP_ENV: process.env.APP_ENV || '',
                REF_NAME: process.env.REF_NAME || '',
                REMOTE_CONFIG_URL: process.env.REMOTE_CONFIG_URL || '',
                REMOTE_CONFIG_URL_PROD: process.env.REMOTE_CONFIG_URL_PROD || '',
                REMOTE_CONFIG_URL_STAGING: process.env.REMOTE_CONFIG_URL_STAGING || '',
            ...
            'process.env.REMOTE_CONFIG_URL_PROD': JSON.stringify(process.env.REMOTE_CONFIG_URL_PROD || ''),
            'process.env.REMOTE_CONFIG_URL_STAGING': JSON.stringify(process.env.REMOTE_CONFIG_URL_STAGING || ''),
